...
/* Local Components */
function Skill({ name }) {
  return <div className="w-fit bg-[#4E435E] group-hover:bg-[#6a5c81] rounded-2xl">
    <p className="text-[#FDF7FF] font-light text-[0.65rem] sm:text-xs lg:text-sm px-1.5 sm:px-2 py-0.5 sm:py-1 whitespace-nowrap">{name}</p>
  </div>;
}

const IndexPage = () => {
  return (
    <main id="" className="w-full min-w-[400px] max-w-[1600px] mx-auto font-raleway text-[#c1bcc4] bg-customPurpleBG p-8 sm:py-10 sm:px-20 md:px-40 lg:px-60 xl:px-80">
      ...
      <div className="text-[#fffefc] font-bold pb-[50px]">
        <ul className="flex flex-row-reverse">
          <li>
            <a href="#contact">
              <div className="group hover:text-[#c1bcc4]">
                <div className="bg-customPurpleBG pb-3"><p className="text-lg md:text-xl lg:text-2xl">Contact</p></div>
          ...
          <li className="pr-5 md:pr-[30px]">
            <a href="#portfolio">
              <div className="group hover:text-[#c1bcc4]">
                <div className="bg-customPurpleBG pb-3"><p className="text-lg md:text-xl lg:text-2xl">Portfolio</p></div>
                <div className="w-full h-1 md:h-[5px] md:mt-1 group-hover:bg-[#8e8691] ease-out duration-300"></div>
              </div>
            </a>
          </li>
      ...
      <div className="mb-3">
        <h className="text-[#fffefc] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">I am Carlo Dino.</h>
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-regular mt-3">A back-end software engineer based in San Francisco.</p>
      </div>
      ...
      {/* Introduction */}
      <div className="text-md sm:text-lg md:text-xl lg:text-2xl mr-15">
        <p className="leading-relaxed">
          Hello there! My name is Carlo Dino and I am a back-end engineer based in San Francisco. I work to turn
          innovative ideas into full-scale applications to be shared across the web. I am currently a full-time
          software engineer at Coinbase and an on-leave coterminal Masters student at Stanford, majoring in Computer
          Science in both of my undergraduate and MS degrees.
      ...
      {/* Projects */}
      <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc] mt-3">Projects</h>
      <ul>
          ...
          <a href="#" aria-label="My portfolio page! (This page, will send you to the top)">
            <div className="w-full mt-5 mx-8 flex flex-row pb-3 sm:pb-0">
              ...
              <div className="w-5/6 mt-2 sm:my-3 mr-12">
                <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc] group-hover:underline">Portfolio</h>
                <p className="text-xs sm:text-sm lg:text-base group-hover:text-[#fffefc] md:mr-5">This page! Responsive site designed using React and Tailwind on top of the Gatsby framework. Any future projects will be added here!</p>
                <div className="w-full mt-2 flex flex-row flex-wrap gap-1">
        ...
        <li id="port-2" className="group rounded-2xl md:rounded-3xl bg-[#342f3b] hover:bg-[#4A4453] w-full my-6 ease-in-out duration-700 hover:duration-200 hover:translate-x-3 transition-all active:bg-[#342f3b]">
          <a className="w-full h-full my-5 mx-8 flex flex-row" href="https://docs.google.com/presentation/d/1P_thLP0G39fU3FC67V7Vi84Y4xjoNIeU0hjbYuVn0vQ/edit?usp=share_link" target="_blank" rel="noreferrer noopener" aria-label="YouTube video overview of the RL model (opens in a new tab)">
            ...
            <div className="w-5/6 ml-4 my-2 sm:my-3 mr-12">
              <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc] group-hover:underline">Poole — A Group-Making App</h>
              <p className="text-xs sm:text-sm lg:text-base group-hover:text-[#fffefc] md:mr-5">Poole is a mobile app conceptualized in Stanford's CS194 — Software Project Experience. The app is designed to facilitate group matching and event participation among students.</p>
              <div className="w-full mt-2 flex flex-row flex-wrap gap-1">
        ...
        <li id="port-4" className="group rounded-2xl md:rounded-3xl bg-[#342f3b] hover:bg-[#4A4453] w-full my-6 ease-in-out duration-700 hover:duration-200 hover:translate-x-3 transition-all active:bg-[#342f3b]">
          <a className="w-full h-full my-5 mx-8 flex flex-row" href="https://drive.google.com/file/d/1fwW_O5MpF29k7AEXxH4yneHjKj1GxV_a/view?usp=sharing" target="_blank" rel="noreferrer noopener" aria-label="Vader's Github Repo (opens in a new tab)">
            ...
            <div className="w-5/6 ml-4 my-2 sm:my-3 mr-12">
              <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc] group-hover:underline">Fraud Moderation Bot</h>
              <p className="text-xs sm:text-sm lg:text-base group-hover:text-[#fffefc] md:mr-5">Developed a Discord content moderation bot that detects, blocks, and reports financial scams and fraud
                within real-time Discord messages to server moderators. Responses powered by GPT-4.</p>
              <div className="w-full mt-2 flex flex-row flex-wrap gap-1">
      ...
      {/* Experience */}
      <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc]">Experience</h>
      <ul className="w-full pt-2 md:pt-4">
        <li className="group w-full flex flex-row">
          <div className="w-4/12 md:w-3/12">
            <p className="sm:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">2025 - Present</p>
          </div>
          <a className="w-8/12 md:w-9/12 duration-300 ease-in-out" href="https://www.coinbase.com/about" target="_blank" rel="noreferrer noopener" aria-label="Intern at the Coinbase (opens in a new tab)">
            <p className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#fffefc] group-hover:underline duration-300 ease-in-out">Software Engineer</p>
            <a href="https://www.coinbase.com/about" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" aria-label="Coinbase's About Page (opens in a new tab)">Coinbase</a>
            <p className="text-xs sm:text-sm lg:text-base pt-3 group-hover:text-[#fffefc] duration-300 ease-in-out">
              Backend software engineer working on the Deposits and Withdrawals experience.
            </p>
            <div className="w-full md:flex md:flex-row">
              <div className="w-full md:w-fit mt-3 flex flex-row flex-wrap gap-1">
                <Skill name="Go"></Skill> <Skill name="Datadog"></Skill>
              </div>
            </div>
          </a>
        </li>
        <li className="group w-full flex flex-row pt-12">
          <div className="w-4/12 md:w-3/12">
            <p className="sm:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">2024 - 2024</p>
          </div>
          <a className="w-8/12 md:w-9/12 duration-300 ease-in-out" href="https://www.coinbase.com/about" target="_blank" rel="noreferrer noopener" aria-label="Intern at the Coinbase (opens in a new tab)">
            <p className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#fffefc] group-hover:underline duration-300 ease-in-out">Software Engineer Intern</p>
            <a href="https://www.coinbase.com/about" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" aria-label="Coinbase's About Page (opens in a new tab)">Coinbase</a>
            <p className="text-xs sm:text-sm lg:text-base pt-3 group-hover:text-[#fffefc] duration-300 ease-in-out">
        ...
        <li className="group w-full flex flex-row pt-12">
          <div className="w-4/12 md:w-3/12">
            <p className="sm:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">2022 - 2023</p>
          </div>
          <a className="w-8/12 md:w-9/12 duration-300 ease-in-out" href="https://cesta.stanford.edu/research/epicconnect" target="_blank" rel="noreferrer noopener" aria-label="Intern at the Center for Spatial and Textual Analysis (opens in a new tab)">
            <p className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#fffefc] group-hover:underline duration-300 ease-in-out">Full Stack Engineer</p>
            <a href="https://cesta.stanford.edu" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" aria-label="Stanford's Center for Spatial and Textual Analysis (opens in a new tab)">Center for Spatial and Textual Analysis</a>
            <p className="text-xs sm:text-sm lg:text-base pt-3 group-hover:text-[#fffefc] duration-300 ease-in-out">
        ...
        <li className="group w-full flex flex-row pt-12">
          <div className="w-4/12 md:w-3/12">
            <p className="sm:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out mr-3">July - Sept 2021</p>
          </div>
          <a className="w-8/12 md:w-9/12 duration-300 ease-in-out" href="https://olh.sweetwaterschools.org/ap-summer-assignments/" target="_blank" rel="noreferrer noopener" aria-label="My high school's webpage (opens in a new tab)">
            <p className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#fffefc] group-hover:underline duration-300 ease-in-out">Teaching Assistant</p>
            <a href="https://olh.sweetwaterschools.org/ap-summer-assignments/" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" aria-label="My high school's webpage (opens in a new tab)">Olympian High School</a>
            <p className="text-xs sm:text-sm lg:text-base pt-3 group-hover:text-[#fffefc] duration-300 ease-in-out">
        ...
        <li className="group w-full flex flex-row pt-12">
          <div className="w-4/12 md:w-3/12">
            <p className="sm:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out mr-3">June - Oct 2021</p>
          </div>
          <a className="w-8/12 md:w-9/12 duration-300 ease-in-out" href="https://curricullege.com/" target="_blank" rel="noreferrer noopener" aria-label="Curricullege front page (opens in a new tab)">
            <p className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-[#fffefc] group-hover:underline duration-300 ease-in-out">Web Developer</p>
            <a href="https://www.chulavistaca.gov/departments/library" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" aria-label="Otay Ranch Public Library's webpage (opens in a new tab)">Otay Ranch Public Library</a>
            <p className="text-xs sm:text-sm lg:text-base pt-3 group-hover:text-[#fffefc] duration-300 ease-in-out">
      ...
      {/* Contact */}
      <h className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#fffefc]">Contact</h>
      <ul className="w-full pt-3 md:pt-5">
        <li className="group w-full flex flex-row">
          <div className="w-4/12 md:w-3/12">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">Email</p>
          </div>
          <div className="w-8/12 md:w-9/12">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none">cdino @ stanford dot edu</p>
          </div>
        </li>
        <li className="group w-full flex flex-row pt-4">
          <div className="w-4/12 md:w-3/12">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">LinkedIn</p>
          </div>
          <div className="w-8/12 md:w-9/12">
            <a href="https://www.linkedin.com/in/carloamiodino/" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" target="_blank" rel="noreferrer noopener" aria-label="My LinkedIn page! (Opens in a new tab)">linkedin/carloamiodino</a>
          </div>
        </li>
        <li className="group w-full flex flex-row pt-4">
          <div className="w-4/12 md:w-3/12">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">GitHub</p>
          </div>
          <div className="w-8/12 md:w-9/12">
            <a href="https://github.com/dev-caelo" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" target="_blank" rel="noreferrer noopener" aria-label="My Github page! (Opens in a new tab)">github/dev-caelo</a>
          </div>
        </li>
        <li className="group w-full flex flex-row pt-4">
          <div className="w-4/12 md:w-3/12">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] duration-300 ease-in-out">Resume</p>
          </div>
          <div className="w-8/12 md:w-9/12">
            <a href="https://drive.google.com/file/d/1kObiJAWXamsyX4qlLl87X1PreL3ynBoZ/view?usp=sharing" className="text-sm sm:text-base md:text-lg lg:text-xl group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out leading-none" target="_blank" rel="noreferrer noopener" aria-label="My Resume! (Opens in a new tab)">carlodino/resume</a>
          </div>
        </li>
      </ul>
      ...
      <div className="w-full md:w-9/12">
        <p className="text-xs sm:text-sm md:text-base lg:text-lg font-light">
          ...
          used is Raleway. Site design was heavily inspired by <a href="https://alexjpate.com" className="text-xs sm:text-sm md:text-base lg:text-lg group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out underline" target="_blank" rel="noreferrer noopener" aria-label="Alex Pate's website! (Opens in a new tab)">Alex Pate's</a>, <a href="https://brittanychiang.com" className="text-xs sm:text-sm md:text-base lg:text-lg group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out underline" target="_blank" rel="noreferrer noopener" aria-label="Brittany Chiang's website! (Opens in a new tab)">Brittany Chiang's</a>, and <a href="https://www.justinchi.me" className="text-xs sm:text-sm md:text-base lg:text-lg group-hover:text-[#fffefc] hover:text-[#342f3b] duration-300 ease-in-out underline" target="_blank" rel="noreferrer noopener" aria-label="Justin Chi's website! (Opens in a new tab)">Justin Chi's</a> own
          portfolio pages.
        </p>
        <p className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#fffefc] pt-16">@ Carlo Dino</p>
      </div>
